(function(){
  ...
  const state={articles:[],filter:'all'};
  ...
  document.addEventListener('DOMContentLoaded',async()=>{state.articles=await B.articles();categories();render();$('#blogSubscribe')?.addEventListener('submit',subscribe);});
})();
