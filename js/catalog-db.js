...
(function () {
  ...
  function toStoreProduct(row) {
    ...
    return {
      ...
      cardDescription: localized(row,"card_description_es","card_description_en") || localized(row,"description_es","description_en"),
      badge: localized(row,"badge_es","badge_en"), cardCta: localized(row,"card_cta_es","card_cta_en"),
